...
public class TraineeToTraineeComparisonFeature {
	...
	@Given("^I selected a trainee$")
	public void i_selected_a_trainee() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Given("^I clicked the Person Icon in the Technical Skills again$")
	public void i_clicked_the_Person_Icon_in_the_Technical_Skills_again() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Given("^I have selected a different Trainee$")
	public void i_have_selected_a_different_Trainee() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
