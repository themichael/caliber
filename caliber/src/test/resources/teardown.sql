...
DROP SEQUENCE IF EXISTS TASK_COMPLETION_ID_SEQUENCE;
DROP SEQUENCE IF EXISTS TASK_ID_SEQUENCE;

DELETE FROM CALIBER_GRADE;
DELETE FROM CALIBER_PANEL_FEEDBACK;
DELETE FROM CALIBER_PANEL;
...
DELETE FROM CALIBER_TASK_COMPLETION;
DELETE FROM CALIBER_TASK;
