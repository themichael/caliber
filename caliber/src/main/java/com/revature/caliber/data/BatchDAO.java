...
public class BatchDAO {
	 ...
	 * Likely to only be useful for calculating reports.
	 * @return
	 */
	...
	/**
	 * Looks for all batches that are currently actively in training.
	 * Useful for VP and QC to get snapshots of currently operating batches.
	 * @param auth
	 * @return
	 */
	@SuppressWarnings("unchecked")
