...
public interface NoteRepository extends JpaRepository<Note, Integer> {
	 ...
	 * @return notes
	 */
	public List<Note> findByTraineeTraineeIdAndWeekAndTypeOrderByWeekAsc(Integer traineeId, Short week, NoteType type);
	 ...
	 * @return notes
	 */
	public List<Note> findByTraineeTraineeIdAndTypeOrderByWeekAsc(Integer traineeId, NoteType type);
	 ...
	 * @return Note
	 */
	public Note findByTraineeTraineeIdAndWeekAndType(Integer traineeId, Short week, NoteType type);
	 ...
	 * @return notes
	 */
	public List<Note> findByBatchBatchIdAndWeekAndTypeOrderByWeekAsc(Integer batchId, Short week, NoteType type);
	 ...
	 * @return notes
	 */
	public List<Note> findByBatchBatchIdAndTypeOrderByWeekAsc(Integer batchId, NoteType type);
}
