...
public interface PanelRepository extends JpaRepository<Panel, Integer> {
	...
	/**
	 * Used to find all the trainee IDs of everyone who has had a panel
	 * 
	 * @return distinct trainee IDs
	 */
	@Query("select distinct p.trainee from Panel")
	public List<Integer> findAllTraineesWithPanels();
