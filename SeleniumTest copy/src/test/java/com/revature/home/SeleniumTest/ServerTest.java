...
//	   }
	   ...
	   public void openC4C() throws InterruptedException{
		   ...
		   dcaps.setCapability("phantomjs.binary.path", "/usr/local/bin/phantomjs");
...
//	       assertEquals("http://localhost:8080/caliber#/vp/manage", driver.getCurrentUrl());
	   ...
	   public void loginAsAdmin(){
		   ...
		   System.out.println(driver.getCurrentUrl());
		   driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		   driver.findElement(By.cssSelector("body > div:nth-child(2) > div > div > div:nth-child(2) > form > div:nth-child(1) > input")).sendKeys("pMuldoon20");
