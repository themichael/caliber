...
INSERT INTO CALIBER_TASK VALUES(CALIBER.TASK_ID_SEQUENCE.NEXTVAL, 1, 'Particpate in three QC Interviews.', 3);
INSERT INTO CALIBER_TASK VALUES(CALIBER.TASK_ID_SEQUENCE.NEXTVAL, 0, 'Create new panel questions.', 4);

-----------------------TASK END-------------------------

-------------------------TRAINER IN TRAINING---------------------------
UPDATE CALIBER_TRAINER SET TITLE = 'Trainer in Training' WHERE TRAINER_ID = 41;
UPDATE CALIBER_TRAINER SET TITLE = 'Trainer in Training' WHERE TRAINER_ID = 42;
UPDATE CALIBER_TRAINER SET TITLE = 'Trainer in Training' WHERE TRAINER_ID = 43;
UPDATE CALIBER_TRAINER SET TITLE = 'Trainer in Training' WHERE TRAINER_ID = 44;
UPDATE CALIBER_TRAINER SET TITLE = 'Trainer in Training' WHERE TRAINER_ID = 45;
-----------------------TRAINER IN TRAINING END-------------------------

---------------------------TASK COMPLETION-----------------------------
INSERT INTO CALIBER_TASK_COMPLETION VALUES(CALIBER.TASK_COMPLETION_ID_SEQUENCE.NEXTVAL, '28-NOV-17', 1, 1, 41);
INSERT INTO CALIBER_TASK_COMPLETION VALUES(CALIBER.TASK_COMPLETION_ID_SEQUENCE.NEXTVAL, '28-NOV-17', 1, 3, 42);
INSERT INTO CALIBER_TASK_COMPLETION VALUES(CALIBER.TASK_COMPLETION_ID_SEQUENCE.NEXTVAL, '28-NOV-17', 1, 1, 43);
INSERT INTO CALIBER_TASK_COMPLETION VALUES(CALIBER.TASK_COMPLETION_ID_SEQUENCE.NEXTVAL, '28-NOV-17', 1, 2, 44);
-------------------------TASK COMPLETION END---------------------------